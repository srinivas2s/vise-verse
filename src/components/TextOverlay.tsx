      ...
      <AnimatePresence mode="wait">
        {phase === 1 ? (
          <motion.div
            ...
            className="absolute inset-0 flex flex-col items-start justify-center pl-10 md:pl-24"
          >
            <h1 
              className="text-white text-6xl md:text-8xl font-['Pricedown','Pricedown_Bl','pricedown'] tracking-normal leading-tight"
              style={{ 
